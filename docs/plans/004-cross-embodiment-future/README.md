# Plan 004 - Cross-Embodiment Future

**Status:** Parked.  
**Purpose:** Preserve the arm-to-arm transfer idea without distracting from the active LIBERO/RoboCasa IDM program.

## Files

| # | Doc | Purpose |
|---|-----|---------|
| 01 | [arm-to-arm-transfer](01-arm-to-arm-transfer.md) | Shared EEF action idea. |
