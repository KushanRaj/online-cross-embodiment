...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="flipud",
        help="Canonical transform applied to both current and future HDF5 frames",
    )
    ...
    metadata = {
        ...
        "frame_convention": f"libero_canonical_{args.frame_transform}",
