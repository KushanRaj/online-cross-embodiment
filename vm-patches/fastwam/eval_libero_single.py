...
def run_single_task(
    ...
    *,
    ...
    prompt_override = cfg.EVALUATION.get("prompt_override", None)
    if prompt_override is None:
        prompt_override = os.environ.get("FASTWAM_PROMPT_OVERRIDE")
    if prompt_override is not None:
        task_description = str(prompt_override)
        logging.info(
            "Using FastWAM prompt override for task %s: canonical=%r override=%r",
    ...
    results = {
        ...
        "success_episodes": [],
        "task_description": task_description,
        "canonical_task_description": canonical_task_description,
